          ...
          <div className="flex items-center justify-center gap-4">
            {[
              ...
              <div key={s.num} className="flex items-center">
                ...
                {s.num < 3 && (
                  <div
                    className={`w-12 h-0.5 mx-2 ${step > s.num ? "bg-firm-orange" : "bg-gray-300"}`}
                  />
                )}
              </div>
            ))}
        ...
        <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="flex justify-between items-center mt-4">
                          <div className="flex items-center gap-3">
                            <button
                              ...
                              disabled={
                                updating === item.product_id || item.quantity <= 1
                              }
          ...
          <div className="lg:w-96">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-5">
              <h2 className="font-['Montserrat_Alternates'] font-bold text-xl mb-4">
                Итого
              </h2>
              ...
              <div className="flex justify-between mt-4 pb-4">
                <span className="font-['Montserrat_Alternates'] font-bold text-lg">
                  Итого к оплате:
                </span>
