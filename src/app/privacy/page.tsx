...
export default function PrivacyPage() {
  ...
  const sections = [
    ...
    { id: "data", title: "Собираемые данные", icon: <UserIcon className="w-4 h-4" color="#D97C8E" /> },
    { id: "usage", title: "Использование данных", icon: <ShieldCheckIcon className="w-4 h-4" color="#94D06C" /> },
    { id: "protection", title: "Защита данных", icon: <LockIcon className="w-4 h-4" color="#F4A67F" /> },
    { id: "rights", title: "Ваши права", icon: <UserIcon className="w-4 h-4" color="#D97C8E" /> },
    { id: "cookies", title: "Cookies", icon: <ClockIcon className="w-4 h-4" color="#94D06C" /> },
    ...
    <div className="min-h-screen bg-main">
      <section className="relative bg-gradient-to-br from-firm-orange/5 via-main to-firm-pink/5 py-16 sm:py-20 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Мы уважаем ваше право на приватность и обязуемся защищать предоставленную вами информацию
          </motion.p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        ...
        >
          ...
          <div className="bg-forms rounded-2xl p-6">
            <p className="text-firm-gray text-sm leading-relaxed mb-4">
              ...
              и защиты персональных данных пользователей платформы «Дом вязаных историй»
              (далее — «Платформа», «Мы», «Наш»).
            </p>
            <p className="text-firm-gray text-sm leading-relaxed">
              Используя Платформу, вы даете согласие на сбор, обработку и хранение ваших персональных
              данных в соответствии с условиями настоящей Политики. Если вы не согласны с условиями,
        ...
        >
          ...
          <div className="bg-forms rounded-2xl p-6">
            <p className="text-firm-gray text-sm leading-relaxed mb-4">
              В процессе использования Платформы мы можем собирать следующую информацию:
            </p>
            <ul className="space-y-3">
              {[
                ...
                "IP-адрес",
                "Данные авторизации через социальные сети (при использовании)",
                "Фотографии и изображения (при добавлении отзывов)",
              ].map((item, idx) => (
        ...
        >
          ...
          <div className="bg-forms rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { title: "Обработка заказов", desc: "Оформление, подтверждение и доставка заказов" },
                { title: "Связь с пользователями", desc: "Уведомления о статусе заказа и ответы на вопросы" },
                { title: "Улучшение сервиса", desc: "Анализ использования Платформы для ее улучшения" },
                { title: "Персонализация", desc: "Рекомендации товаров и персонализация контента" },
                { title: "Безопасность", desc: "Предотвращение мошенничества и защита от атак" },
                { title: "Маркетинг", desc: "Информирование об акциях и новинках (с вашего согласия)" },
              ].map((item, idx) => (
        ...
        >
          ...
          <div className="bg-forms rounded-2xl p-6">
            <p className="text-firm-gray text-sm leading-relaxed mb-4">
              Мы принимаем все необходимые организационные и технические меры для защиты ваших
            ...
            <p className="text-firm-gray text-sm leading-relaxed">
              Однако, ни один метод передачи данных через интернет или метод электронного хранения
              не является на 100% безопасным. Поэтому, хотя мы стремимся использовать коммерчески
              приемлемые средства защиты, мы не можем гарантировать абсолютную безопасность.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="bg-forms rounded-2xl p-6">
            ...
            <p className="text-firm-gray text-sm leading-relaxed mt-4">
              Для реализации ваших прав, пожалуйста, обратитесь к нам через контактные данные,
        ...
        >
          ...
          <div className="bg-forms rounded-2xl p-6">
            <p className="text-firm-gray text-sm leading-relaxed mb-4">
              Наша Платформа использует файлы cookie и аналогичные технологии для улучшения
              пользовательского опыта, анализа трафика и персонализации контента.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              {[
                { type: "Необходимые", desc: "Обеспечивают базовую работу сайта" },
                { type: "Функциональные", desc: "Запоминают ваши предпочтения" },
            ...
            <p className="text-firm-gray text-sm leading-relaxed">
              Вы можете управлять файлами cookie через настройки вашего браузера. Отключение
              некоторых типов cookie может повлиять на функциональность Платформы.
            </p>
          </div>
        </motion.div>
          ...
          <div className="bg-forms rounded-2xl p-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <Link href="mailto:privacy@knitted-history.ru" className="text-text text-sm hover:text-firm-orange transition-colors break-all">
                  privacy@knitted-history.ru
                </Link>
              </div>
              <div>
        ...
        >
          ...
          <p className="text-firm-gray text-sm leading-relaxed">
            Мы можем время от времени обновлять нашу Политику конфиденциальности. О любых изменениях
            мы уведомим вас путем публикации новой Политики на этой странице. Рекомендуем периодически
            просматривать эту страницу для получения актуальной информации. Изменения вступают в силу
            с момента их публикации.
          </p>
          <p className="text-firm-gray text-xs mt-4">
            Актуальная версия Политики: 2.4 от {lastUpdated}
          </p>
        </motion.div>
      </div>
