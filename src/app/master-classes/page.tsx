...
import { NoClassesIcon } from "@/components/icons/NoClassesIcon"
import { NoRegistrationsIcon } from "@/components/icons/NoRegistrationsIcon"
import { NoCreatedIcon } from "@/components/icons/NoCreatedIcon"
                                        ...
                                        return (
                                            <div className="text-center py-16 bg-gray-50 rounded-xl">
                                                <div className="mb-4 flex justify-center">
                                                    <NoClassesIcon size={80} color="#D4D4D4" />
                                                </div>
