...
export async function GET(request: Request) {
    try {
        ...
        let mastersQuery = supabase.from('masters').select('user_id, total_sales, rating, is_verified, is_partner, custom_orders_enabled').in('user_id', userIds);
