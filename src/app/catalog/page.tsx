        ...
        <div className="mt-5 flex items-start justify-center">
            <div className="flex flex-col gap-5 w-[90%] max-w-7xl">
                ...
                <div className="relative w-full md:w-96">
                    <input type="text" placeholder="Поиск по названию..." value={filters.search} onChange={(e) => handleSearch(e.target.value)} className="w-full p-3 pl-10 rounded-lg bg-[#eaeaea] outline-firm-orange" />
                ...
                <div className="flex gap-6">
                    ...
                    <div className="w-3/4">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <select value={filters.sort} onChange={(e) => handleFilterChange({ sort: e.target.value })} className="p-2 rounded-lg bg-[#eaeaea] outline-firm-pink font-['Montserrat_Alternates']">
