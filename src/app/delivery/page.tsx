...
export default function DeliveryPage() {
  ...
  const deliveryMethods = [
    {
      icon: <TruckIcon className="w-8 h-8" color="#F4A67F" />,
      title: "Курьерская доставка",
      price: "350 ₽",
      priceFree: "Бесплатно при заказе от 5 000 ₽",
      time: "1-3 рабочих дня",
      description: "Доставка курьером до двери. Вы сможете отслеживать статус заказа в личном кабинете.",
    },
    {
      icon: <PackageIcon className="w-8 h-8" color="#D97C8E" />,
      title: "Пункты выдачи заказов",
      price: "250 ₽",
      priceFree: "Бесплатно при заказе от 3 000 ₽",
      time: "2-4 рабочих дня",
      description: "Более 5000 пунктов выдачи по всей России. Удобный способ получения заказа.",
    },
    {
      icon: <LocateIcon className="w-8 h-8" color="#94D06C" />,
      title: "Почта России",
      price: "от 200 ₽",
      priceFree: "Бесплатно при заказе от 4 000 ₽",
  ...
  const regions = [
    { name: "Москва и Московская область", time: "1-2 дня", price: "350 ₽" },
    { name: "Санкт-Петербург и ЛО", time: "1-3 дня", price: "400 ₽" },
    { name: "Другие города России", time: "3-7 дней", price: "от 350 ₽" },
    { name: "Удаленные регионы (Крайний Север, ДВ)", time: "7-14 дней", price: "от 500 ₽" },
  ];

  const rules = [
    "Заказ обрабатывается в течение 1-2 рабочих дней после подтверждения оплаты",
    "После отправки заказа вы получаете трек-номер для отслеживания",
    "Срок хранения заказа в пункте выдачи — 7 дней",
    "При необходимости примерки курьер ждет до 15 минут",
    "Изменение адреса доставки возможно до момента отправки заказа",
    "При неполучении заказа в срок, он возвращается продавцу, стоимость доставки не компенсируется",
  ];

  const returnConditions = [
    "Товар не подошел по размеру, цвету или фасону",
    "Товар имеет производственный брак",
    "Товар не соответствует описанию на сайте",
    "Срок возврата — 14 дней с момента получения заказа",
    "Товар должен быть в оригинальной упаковке с сохранением всех ярлыков",
  ];
    ...
    <div className="min-h-screen bg-main">
      ...
      <section className="relative bg-gradient-to-br from-firm-orange/5 via-main to-firm-pink/5 py-16 sm:py-20 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Удобные способы доставки по всей России. Мы заботимся о том,
            чтобы ваши покупки пришли быстро и в сохранности.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-firm-gray text-sm sm:text-base mt-4 max-w-2xl mx-auto">
              Выберите наиболее удобный для вас вариант получения заказа
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {deliveryMethods.map((method, idx) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="bg-main rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300"
              >
                <div className="flex justify-center mb-4">{method.icon}</div>
                <h3 className="font-['Montserrat_Alternates'] font-semibold text-xl text-text text-center mb-2">
                  {method.title}
                </h3>
                ...
                <p className="text-firm-gray text-xs sm:text-sm text-center leading-relaxed">
                  {method.description}
                </p>
              </motion.div>
            ))}
      ...
      <section className="py-12 sm:py-16 bg-forms">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <tbody>
                  {regions.map((region, idx) => (
                    <motion.tr
                      ...
                      className="border-b border-gray-100 hover:bg-forms transition-all duration-300"
                    >
          ...
          <motion.p
            ...
            className="text-firm-gray text-xs text-center mt-4"
          >
            * Точную стоимость доставки вы можете рассчитать при оформлении заказа
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-['Montserrat_Alternates'] font-semibold text-2xl text-text">
                  Правила доставки
                </h2>
              </div>
            ...
            >
              ...
              <p className="text-firm-gray text-sm mb-4">
                Вы можете вернуть товар надлежащего качества в течение 14 дней после получения, если:
              </p>
              ...
              <div className="bg-forms rounded-xl p-4">
                <p className="text-firm-gray text-xs sm:text-sm">
                  <span className="font-semibold text-text">Важно:</span> Возврат товаров ручной работы
                  осуществляется в соответствии с законодательством РФ. Изделия, созданные на заказ,
                  возврату и обмену не подлежат, если они не имеют брака.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-12 sm:py-16 bg-forms">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                icon: <CartIcon className="w-8 h-8" color="#F4A67F" />,
              ...
              {
                icon: <ClockIcon className="w-8 h-8" color="#94D06C" />,
                title: "Другие способы",
                items: ["Наличные курьеру", "Безналичный расчет"],
              },
            ].map((method, idx) => (
              <motion.div
                key={method.title}
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {method.items.map((item) => (
                    <span key={item} className="px-3 py-1 bg-forms text-firm-gray rounded-full text-xs">
                      {item}
                    </span>
                  ))}
                </div>
          ...
          <motion.div
            ...
            className="mt-8 bg-firm-green/10 rounded-xl p-4 text-center"
          >
            <p className="text-firm-green text-sm font-medium">
              🔒 Безопасность платежей гарантирована. Все транзакции проходят через защищенный шлюз.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {[
              {
                ...
                answer: "После отправки заказа вы получите трек-номер на email и в SMS. Отслеживать статус можно в личном кабинете или на сайте службы доставки.",
              },
              {
                question: "Могу ли я изменить адрес доставки?",
                answer: "Да, вы можете изменить адрес доставки до момента отправки заказа. Для этого свяжитесь с нашей службой поддержки.",
              },
              {
                question: "Что делать, если заказ не пришел?",
                answer: "Если заказ не пришел в указанные сроки, свяжитесь с нашей поддержкой. Мы проверим статус и поможем решить проблему.",
              },
              {
                question: "Можно ли вернуть товар, если он не подошел?",
                answer: "Да, вы можете вернуть товар надлежащего качества в течение 14 дней. Исключение — товары, изготовленные на заказ.",
              },
            ].map((faq, idx) => (
              <motion.div
                key={faq.question}
                ...
                className="bg-forms rounded-xl p-5 hover:shadow-md transition-all duration-300"
              >
                <h3 className="font-['Montserrat_Alternates'] font-semibold text-text text-base sm:text-lg mb-2">
                  {faq.question}
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-firm-gray text-sm sm:text-base max-w-2xl mx-auto mb-6">
              Наша служба поддержки всегда готова помочь вам с любыми вопросами о доставке и оплате
            </p>
