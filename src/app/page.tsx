...
export default function HomePage() {
    ...
    return (
        <div className="ml-[5%] w-[90%] mr-[5%]">
            ...
            <TopMasters />
            <div className="flex items-center gap-20 justify-center mt-5 mb-16">
                <Link href="/catalog" className="w-[20%]">
                    <button className="w-full font-['Montserrat_Alternates'] font-[450] border-2 border-firm-pink p-2 rounded-xl transition-all duration-300 hover:scale-105 hover:border-4 hover:bg-firm-pink hover:text-white hover:cursor-pointer">
                        Найти изделие для себя
                    </button>
                </Link>
                <Link href="/masters" className="w-[20%]">
                    <button className="w-full font-['Montserrat_Alternates'] font-[450] border-2 border-firm-orange p-2 rounded-xl transition-all duration-300 hover:scale-105 hover:border-4 hover:bg-firm-orange hover:text-white hover:cursor-pointer">
            ...
            <div className="py-16">
                ...
                {loadingPosts ? (
                    ...
                    <div className="space-y-6 flex justify-center">
                        {recentPosts.map((post) => (
                            <div key={post.id} className="bg-white rounded-lg shadow-md overflow-hidden w-1/2">
                                {/* Шапка поста */}
                                <div className="p-4 flex items-center justify-between border-b border-gray-200">
                                    <Link href={`/masters/${post.master_id}`} className="flex items-center gap-3">
                                ...
                                <div className="px-4 py-3 border-t border-gray-200 flex items-center gap-6">
                                                                    ...
                                                                    <span className="text-s text-gray-400 flex items-center gap-1">
                ...
                <div className="text-center mt-12">
                    <Link
                        href="/blog"
                        className="inline-flex items-center gap-2 px-6 py-3 border-2 border-firm-pink text-firm-pink rounded-xl font-['Montserrat_Alternates'] font-medium hover:bg-firm-pink hover:text-white transition-all duration-300"
                    >
                        Перейти в блог
