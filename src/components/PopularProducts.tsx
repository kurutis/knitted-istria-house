                ...
                <div className="flex justify-center min-h-13">
                    <Link href="/catalog" className="inline-block">
                        <motion.button
                            ...
                            className="font-['Montserrat_Alternates'] font-[450] border-2 border-firm-orange p-2 px-6 rounded-xl transition-all duration-300 hover:border-4 hover:bg-firm-orange hover:text-white text-sm lg:text-base whitespace-nowrap"
                            style={{ 
                                transform: 'translateZ(0)',
                                backfaceVisibility: 'hidden',
                                WebkitFontSmoothing: 'antialiased'
