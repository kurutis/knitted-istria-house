...
export const FavoritesIcon = ({ color = "#242424", className = "", size = 32 }: FavoritesIconProps) => (
    <svg 
        width={size} 
        height={size} 
        viewBox="0 0 32 32" 
