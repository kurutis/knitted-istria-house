          ...
          {first && (
            ...
            >
              <Link href={`/masters/${first.id}`}>
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-main text-white px-2 py-0.5 rounded-full text-[10px] font-semibold whitespace-nowrap shadow-md flex items-center gap-1">
      ...
      <div className="flex justify-center items-end gap-4 lg:gap-8 flex-wrap">
        ...
        {first && (
          ...
          >
            <Link href={`/masters/${first.id}`}>
              <motion.div 
                className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-main text-white px-3 py-0.5 lg:px-4 lg:py-1 rounded-full text-xs lg:text-sm font-semibold shadow-lg whitespace-nowrap flex items-center gap-1"
