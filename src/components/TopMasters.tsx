          ...
          {first && (
            ...
            >
              <Link href={`/masters/${first.id}`}>
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-firm-orange to-firm-pink px-2 py-0.5 rounded-full text-[10px] font-semibold whitespace-nowrap shadow-md flex items-center gap-1">
                  <TrophyIcon />
                  <span className="text-white">1 место</span>
                </div>
                {first.avatar_url ? (
