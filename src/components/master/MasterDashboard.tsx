  ...
  const [categories, setCategories] = useState<
    {
      id: number;
      name: string;
      subcategories?: { id: number; name: string; subcategories?: unknown[] }[];
    }[]
  >([]);
                ...
                <form onSubmit={handleSubmitProduct} className="p-6 space-y-6">
                    ...
                    {imagePreviews.length > 0 && (
                      <div className="mt-4">
                        <p className="text-sm text-gray-500 mb-2">
                          Загружено фото: {imagePreviews.length}/10
                        </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        className="w-full p-3 rounded-xl bg-gray-100 outline-none focus:ring-2 focus:ring-firm-pink transition-all duration-300"
                        name="category"
                    ...
                    <div>
                      ...
                      >
                        ...
                        {yarns.map((yarn) => (
                          <option key={yarn.id} value={yarn.id}>
                            {yarn.name} - {yarn.brand}
                          </option>
                        ))}
                        <option value="custom">
                          Другая пряжа (указать вручную)
                        </option>
                      </select>
                      {productForm.yarn_id === "custom" && (
                        <input
                          type="text"
                          name="custom_yarn"
                          value={productForm.custom_yarn}
                          onChange={handleProductInputChange}
                          placeholder="Укажите название пряжи"
                          className="w-full mt-2 p-3 rounded-xl bg-gray-100 outline-none focus:ring-2 focus:ring-firm-pink transition-all duration-300"
                        />
                      )}
                    </div>
                    <div>
                  ...
                  <div className="flex gap-3 pt-4 border-t border-gray-200">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      disabled={saving}
                      className="flex-1 py-3 bg-gradient-to-r from-firm-orange to-firm-pink text-white rounded-xl hover:shadow-lg transition-all duration-300 disabled:opacity-50 font-['Montserrat_Alternates'] font-medium"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => setShowAddProductModal(false)}
                      className="px-6 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition-all duration-300"
                    >
                      Отмена
                    </button>
                  </div>
                ...
                <form onSubmit={handleSubmitClass} className="p-6 space-y-6">
                  ...
                  <div className="flex gap-3 pt-4 border-t">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      disabled={saving}
                      className="flex-1 py-3 bg-gradient-to-r from-firm-pink to-purple-500 text-white rounded-xl hover:shadow-lg transition-all duration-300 disabled:opacity-50 font-['Montserrat_Alternates'] font-medium"
                    >
              ...
              >
                ...
                <form onSubmit={handleSubmitPost} className="p-6 space-y-6">
                  <div>
                    ...
                    <div
                      className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-500 transition cursor-pointer"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full p-3 rounded-xl bg-gray-100 outline-none focus:ring-2 focus:ring-gray-500 transition-all duration-300"
                    />
                  </div>
                  ...
                  <div className="flex gap-3 pt-4 border-t">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      disabled={saving}
                      className="flex-1 py-3 bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-xl hover:shadow-lg transition-all duration-300 disabled:opacity-50 font-['Montserrat_Alternates'] font-medium"
                    >
